...
public class TraitTrash
{
    ...
    public int traitEffectValue1;   //특성1 효과 수치
    public int traitEffectMulti1;   //효과1 곱연산
    public int traitEffectType2;    //특성2 효과 타입
    public int traitEffectValue2;   //특성2 효과 수치
    public int traitEffectMulti2;   //효과2 곱연산
    public int traitEffectType3;    //특성3 효과 타입
    public int traitEffectValue3;   //특성3 효과 수치
    public int traitEffectMulti3;   //효과3 곱연산
    public int traitEffectType4;    //특성4 효과 타입
    public int traitEffectValue4;   //특성4 효과 수치
    public int traitEffectMulti4;   //효과4 곱연산
}
